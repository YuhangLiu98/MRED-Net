# MRED-net
This repository contains the PyTorch implementation of the paper: [**MRED-Net: A Pure Tokens-to-Token Visual Mamba-based Residual Encoder-Decoder Network for Low-Dose CT Denoising**](https://www.sciencedirect.com/science/article/pii/S095741742503920X?dgcid=coauthor)
***************************************************************************
